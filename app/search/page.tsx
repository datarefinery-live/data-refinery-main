...
export default function SearchResults() {
  ...
  // Sample results for design testing
  const sampleResults = [
    { title: "Kerala Regional Node", path: "/global/asia/india/kerala", desc: "Data aggregation cluster for Southwest India." },
    { title: "Global Climate Module", path: "/global/weather", desc: "Standardized weather monitoring and analytics." },
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-mono p-8 text-gray-800">
      <header className="max-w-4xl mx-auto flex justify-between items-center mb-12 border-b border-gray-50 pb-6">
        {/* Updated Home Button to 'data refinery' */}
        ...
        <div className="text-[10px] text-gray-400 uppercase tracking-widest bg-gray-50 px-3 py-1 rounded-full">
      ...
      <main className="max-w-4xl mx-auto">
        ...
        {/* If no results could be logically found in real scenario */}
