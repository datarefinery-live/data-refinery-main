 ...
 * Professional Visualization for Global Intelligence
 * Version: 2.1.2 | Fixed: Mobile Responsiveness & Branding
 */
export default function Home() {
  ...
  // Node Configuration for Kerala Specific Data Streams
  const featuredNodes = [
    { 
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white font-mono antialiased text-gray-800 overflow-hidden">
      ...
      {/* Top Global Navigation Bar - Responsive Padding */}
      ...
      <main className="flex flex-col items-center w-full max-w-4xl px-6 -mt-12 md:-mt-16">
        ...
        {/* Adjusted Logo Scale for Mobile/Desktop Balance */}
        ...
        {/* Search Command Center - Optimized for Full Text Visibility */}
      ...
      {/* Global Status Footer - Finalized Branding */}
      <footer className="absolute bottom-0 w-full flex flex-col md:flex-row justify-between items-center py-4 md:py-6 px-6 md:px-10 text-[8px] md:text-[10px] text-gray-400 border-t border-gray-50 uppercase tracking-tighter bg-white/80 backdrop-blur-sm">
        <div className="flex items-center space-x-3 md:space-x-4">
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            {/* System Parameters (Responsive Wrap) */}
            <div className="flex flex-wrap items-center gap-x-2 md:gap-x-3 font-semibold tracking-widest text-gray-500">
        ...
        {/* Corporate Legal Identity - Ezhuthola edTech Full Form */}
